<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="companies.aspx.cs" Inherits="Pages_companies" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <section class="text-gray-600 body-font">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                    <p class="title-font sm:text-4xl text-3xl mb-4 font-large text-white">Search the Company you wanted all along.....</p>
    ...
    <div>
        <asp:Label runat="server">This is companies page</asp:Label>
    </div>
</asp:Content>
